...
type SerializableFilter struct {
	...
	Config  *string `json:"config,omitempty" yaml:"name,omitempty"`
...
// FService represents a Kong Service and its associated routes, plugins and filter chains.
// +k8s:deepcopy-gen=true
...
// FRoute represents a Kong Route and its associated plugins and filter chains.
// +k8s:deepcopy-gen=true
type FRoute struct {
...
// FUpstream represents a Kong Upstream and its associated targets.
// +k8s:deepcopy-gen=true
